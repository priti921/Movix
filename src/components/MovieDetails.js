        ...
        <div className="Movie-details-page">
            ...
            <ul className="movie-details-details">
                ...
                <ul className="movie-page-data">
                    ...
                    <li className="movie-page-release-year">{Data.release_date}</li>
                    {/* <li className="movie-page-genres">{Data.genres[0]["name"]}</li> */}
                    {/* <li className="movie-page-genre">{Data.genres[1]["name"]}</li>
                    <li className="movie-page-genre">{Data.genres[2]["name"]}</li> */}
                </ul>
